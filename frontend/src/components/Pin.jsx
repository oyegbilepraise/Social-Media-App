  ...
  return (
    <div className="m-2">
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  href={destination}
                  target="_blank"
                  className="bg-white flex items-center gap-2 text-bold text-black font-bold pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
                >
      ...
      <Link to={`user-profile/${postedBy?._id}`} className='flex gap-2 mt-2 items-center'>
        ...
        <p className="font-semi-bold capitalize">
